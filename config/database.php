...
return [
    ...
    */
    ...
    |
    |
    | Todo o trabalho de banco de dados no Laravel é feito através das facilidades do PHP PDO
    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database' => env('DB_DATABASE', 'cherry'),
        ...
        'pgsql' => [
            ...
            'database' => env('DB_DATABASE', 'cherrycms'),
            'username' => env('DB_USERNAME', 'root'),
            'password' => env('DB_PASSWORD', ''),
            'charset' => 'utf8',
            'prefix' => '',
